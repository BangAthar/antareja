        ...
        <div class=" w-[98%] md:w-[55%] h-full bg-gray-100 rounded-xl shadow-xl mx-auto mt-[25%] sm:mt-[30%] md:mt-[15%] pb-16">
            ...
            <div class="container w-full md:w-[80%] mx-auto mt-5">
                <div class="flex flex-col md:flex-col justify-center items-center w-[80%] mx-auto">
                    <a href="/daftar-team" class="bg-red-500 hover:bg-red-400 text-white shadow-nopal font-medium py-2 px-1 w-full text-center rounded focus:outline-none focus:shadow-outline mt-5">
                        Daftarkan Team!
                    </a>
                    <a href="/daftar-akun" class="bg-red-500 hover:bg-red-400 text-white font-medium shadow-nopal py-2 px-1 w-full text-center rounded focus:outline-none focus:shadow-outline mt-10">
