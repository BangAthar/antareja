                    ...
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 class="font-semibold text-base text-blueGray-700 uppercase">
                                <i class="fa-solid fa-bullhorn mr-2"></i> Buat Pengumuman / Informasi
                            </h3>
                        </div>
                        <div class="relative w-full max-w-full flex flex-col gap-2">
                                <form action="/dashboard/create-informasi" method="POST" class="space-y-4">
                                  @csrf
                                  @if (session()->has('success'))
                                     <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4 alert-box" role="alert">
                                        ...
                                        <span class="block w-[95%]">Pengumauman anda berhasil ditambahkan!</span>
                                  ...
                                  @endif
                                  <div>
                                    <label for="pesan" class="block font-semibold mb-2">Annoucement / Pengumuman</label>
                                        <input id="x" type="hidden" name="pesan">
                                        <trix-editor input="x"></trix-editor>
                                    {{-- <textarea id="pesan" name="pesan" class="border-gray-300 border rounded-md px-4 py-2 w-full" rows="5" required></textarea> --}}
                                  </div>
